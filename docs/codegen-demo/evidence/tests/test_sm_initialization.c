...
static void test_sm_tc_init_default(void)
{
    ...
    ADIA_AssertBool(false, instance.data.over_temperature, "over_temperature value", __FILE__, (unsigned long)__LINE__);
    ADIA_AssertU32((uint32_t)180, (uint32_t)instance.data.setpoint_c, "setpoint_c value", __FILE__, (unsigned long)__LINE__);
    ADIA_AssertBool(false, instance.data.start_cmd, "start_cmd value", __FILE__, (unsigned long)__LINE__);
    ADIA_AssertBool(false, instance.data.stop_cmd, "stop_cmd value", __FILE__, (unsigned long)__LINE__);
