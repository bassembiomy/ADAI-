...
| SYSML-007 | BDD composition | supported | `bdd.ts`, `mutations.ts`, `sysmlTransactionAdapter.ts`, `RelationshipEndEditor.tsx` | `mutations.test.ts`, `sysmlTransactionAdapter.test.ts`, `sysml-deletion-lifecycle.spec.ts`, `patches.test.ts` | None; fully qualified. |
...
| SYSML-031 | Typed semantic policy decisions | supported | `policy.ts`, `bdd.ts`, `ibd.ts`, `mutations.ts` | `policy.test.ts`, `bdd.test.ts`, `ibd.test.ts`, `validation.test.ts`, `mutations.test.ts`, `sysmlTransactionAdapter.test.ts`, `sysml-deletion-lifecycle.spec.ts`, `patches.test.ts` | None; fully qualified. |
