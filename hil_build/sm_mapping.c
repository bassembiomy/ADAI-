...
const uint32_t SM_State_Parent_Layer_Map[SM_NUM_STATES + 1U] = {
    [0] = 0U,
    [SM_ST__535DDD5A_C012_46CE_B23C_9A6CE8D81DF6_IDX] = SM_LYR_ROOT_IDX,
    [SM_ST__979256A5_9D43_41F5_929F_5B27AD7DEB22_IDX] = SM_LYR_ROOT_IDX,
};

const int32_t SM_State_Active_Slot_Map[SM_NUM_STATES + 1U] = {
    [0] = -1,
    [SM_ST__535DDD5A_C012_46CE_B23C_9A6CE8D81DF6_IDX] = 0,
    [SM_ST__979256A5_9D43_41F5_929F_5B27AD7DEB22_IDX] = 0,
};
