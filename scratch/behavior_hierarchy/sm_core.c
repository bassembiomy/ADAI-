...
/* Model: ADIA State Machine | 2026-07-20 11:18:17 UTC */
...
void SM_Reset(ADIA_Instance_t* instance) {
    ...
    instance->error_status = SM_ERR_NONE;
    SM_Enter_Layer_1(instance, false);
}
...
static void SM_Enter_State_Shallow(ADIA_Instance_t* instance, SM_Node_t state) {
    switch (state) {
        case SM_ST_C:
            ...
            instance->state_timers[0U] = 0U;
            SM_ST_C_Entry(instance);
            break;
        case SM_ST_D:
            instance->active_states[0U] = state;
            instance->state_active[1U] = true;
            instance->state_timers[1U] = 0U;
            SM_ST_D_Entry(instance);
            break;
        case SM_ST_P:
...
static void SM_Enter_Layer_0(ADIA_Instance_t* instance, bool use_history) {
    if (use_history && (instance->history_states[0U] != SM_NODE_INVALID)) {
        ...
        SM_Enter_State(instance, SM_ST_C, false);
    }
}
...
static void SM_Step_Layer_0(ADIA_Instance_t* instance, uint32_t delta_ms) {
    switch (instance->active_states[0U]) {
        case SM_ST_C:
            ...
            if ((instance->data.t1)) {
                SM_Exit_State(instance, SM_ST_C);
                SM_Exit_State(instance, SM_ST_P);
                /* Action */
                instance->data.log = (uint32_t)(instance->data.log * 10U + 3U);
                SM_Enter_State(instance, SM_ST_Q, false);
                return;
            }
            else { /* MISRA 15.7 */ }
            /* Run During Actions */
            SM_ST_C_During(instance, delta_ms);
            break;
        case SM_ST_D:
            /* Evaluate Outgoing Transitions */
            /* Run During Actions */
            SM_ST_D_During(instance, delta_ms);
            break;
        default:
            break;
    }
...
static void SM_Step_Layer_1(ADIA_Instance_t* instance, uint32_t delta_ms) {
    switch (instance->active_states[1U]) {
        ...
        case SM_ST_Q:
            /* Evaluate Outgoing Transitions */
            if ((instance->data.t2)) {
                SM_Exit_State(instance, SM_ST_Q);
                SM_Enter_State_Shallow(instance, SM_ST_P);
                SM_Enter_State(instance, SM_ST_D, false);
                return;
            }
            else { /* MISRA 15.7 */ }
            /* Run During Actions */
            SM_ST_Q_During(instance, delta_ms);
            break;
        default:
            break;
    }
