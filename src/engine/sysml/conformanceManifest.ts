...
export const CONFORMANCE_MANIFEST: ConformanceManifest = {
  ...
  rows: [
    ...
    {
      id: 'SYSML-032',
      capability: 'SysML Use-Case View & Metamodel',
      status: 'supported',
      ...
      implementationEvidence: [
        ...
        'src/engine/sysml/connectionPolicy.ts',
        'src/services/sysmlCommandGateway.ts',
        'src/components/usecase/useCaseProjection.ts',
        'src/components/usecase/UseCaseWorkspace.tsx',
        'src/components/usecase/UseCaseInspector.tsx',
        'src/components/usecase/UseCaseRelationshipEditor.tsx',
        'src/components/usecase/UseCaseReferencePicker.tsx',
        'src/features/reporting/reportDiagrams.ts',
        'src/features/plantuml/adapters/useCaseAdapter.ts',
      ],
      automatedEvidence: [
        'src/engine/sysml/useCases.test.ts',
        'src/engine/sysml/useCaseMigration.test.ts',
        'src/engine/sysml/useCaseLifecycle.test.ts',
        'src/components/usecase/useCaseProjection.test.ts',
        'src/components/usecase/UseCaseWorkspace.test.tsx',
        'src/components/usecase/UseCaseInspector.test.tsx',
        'src/components/usecase/UseCaseRelationshipEditor.test.tsx',
        'src/components/usecase/UseCaseReferencePicker.test.tsx',
        'src/features/reporting/reportDiagrams.usecase.test.ts',
        'src/features/plantuml/adapters/useCaseAdapter.test.ts',
        'src/engine/sysml/useCaseLargeModel.test.ts',
        'tests/e2e/sysml-usecase-conformance.spec.ts',
      ],
    },
  ],
};
